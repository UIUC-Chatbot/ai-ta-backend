...
messages = [
    {"role": "system", "content": "You are an expert at doing literature review and determining if a piece of text is relevant to a research question by calling all four questions: keep_current_chunk, check_preivous_chunk, check_next_chunk, and go_to_url."},
    {"role": "user", "content": f"Given the question query is {query}, and the current chunk is {chunks[1]}. Is the current chunk relevant to the query? If not, what about the previous"},
]
