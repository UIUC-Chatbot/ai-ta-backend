from sqlalchemy import Column, BigInteger, Text, DateTime, Boolean, ForeignKey, Index, JSON
...
class DocGroup(Base):
    ...
    __table_args__ = (
        Index('doc_groups_enabled_course_name_idx', 'enabled', 'course_name', postgresql_using='btree'),
    )
