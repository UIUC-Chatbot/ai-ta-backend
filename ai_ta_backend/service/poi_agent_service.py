...
def initalize_sql_agent():
    
    ### LLM
    llm = ChatOpenAI(model="gpt-4o", temperature=0)

    ### DATABASE
    db = SQLDatabase.from_uri("sqlite:///C:/Users/rohan/OneDrive/Desktop/NCSA_self_hostable_chatbot/self-hostable-ai-ta-backend/ai_ta_backend/service/plants_of_India_demo.db")
